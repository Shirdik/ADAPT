  ...
  return (
    <React.Fragment>
      <div className="antialiased bg-gray-200">
        ...
        <nav className="lg:px-16 px-6 flex flex-wrap items-center lg:py-0 py-2 nm-flat-gray-200 rounded-full mx-10 my-2">
          <div className="flex flex-1 justify-between items-center">
            <Link to="/" className="flex nm-flat-gray-200 rounded-3xl">
              <svg
                id="Layer_1"
            ...
            <div className="hidden sm:flex">
              ...
              <div className="">
                <NavLink className="mx-auto" to="/Deals">
                  Deals
                </NavLink>
              </div>
              <div className="">
                <NavLink className="mx-auto" to="/Coupons">
                  Coupons
                </NavLink>
              </div>
            </div>
                      ...
                      <div className="nm-flat-gray-300 rounded-lg w-24 m-1">
                        <div>
                          <div className="grid grid-cols-2 py-1">
                            ...
                            <NavLink
                              className="flex items-center p-2 -m-7 transition duration-150 ease-in-out rounded-lg hover:text- focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 "
                              to="/"
                            >
                              Home
                            </NavLink>
        ...
        <div className="bg-gray-200 pt-1"></div>
      </div>
    </React.Fragment>
  );
};
